...
export default function DashboardPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F5F2F0] text-[#151617] flex">
      {/* ─────────────────────────────────────────────────────────────
      ...
      <aside className="w-64 flex-shrink-0 bg-[#FAFAF9] border-r-2 border-[#151617] flex flex-col justify-between p-5 min-h-screen sticky top-0 hidden md:flex">
        <div className="space-y-6">
          {/* Brand Header */}
          <Link href="/" className="flex items-center gap-2.5 pb-4 border-b-2 border-[#151617]/10">
            <div className="w-7 h-7 rounded-[8px] bg-[#FFBE98] border-2 border-[#151617] flex items-center justify-center font-display text-sm text-[#151617] shadow-comic-sm">
              A
            </div>
            <div>
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <span className="px-1.5 py-0.2 rounded-[4px] bg-[#151617] text-white text-[10px] font-mono font-bold">
                {sites.length}
              </span>
            </button>
            ...
            >
              ...
              <span className="text-[10px] font-mono text-[#151617]/60">
                {totalTools}
              </span>
            </button>
          </div>
          ...
          <div className="space-y-1 pt-4 border-t-2 border-[#151617]/10">
            <div className="font-mono text-[10px] uppercase tracking-wider text-[#151617]/50 font-bold px-3 mb-2">
              INFRASTRUCTURE
            </div>
            ...
            <Link
              href="/#scanner"
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-[10px] text-xs font-bold text-[#151617]/80 hover:bg-[#F5F2F0] transition-colors"
            >
              <FileCode className="h-4 w-4 text-[#151617]" />
              <span>Script CDN</span>
            </Link>

            <div className="w-full flex items-center justify-between px-3 py-2 rounded-[10px] text-xs font-bold text-[#151617]/80">
              <div className="flex items-center gap-2.5">
      ...
      <main className="flex-1 p-6 sm:p-10 max-w-[1400px]">
        {/* Top Control Bar */}
        <div className="p-5 sm:p-6 rounded-[14px] bg-[#FAFAF9] border-2 border-[#151617] shadow-comic flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-display text-2xl sm:text-3xl text-[#151617]">
            ...
            <p className="text-xs font-medium text-[#151617]/70 mt-1">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2.5 rounded-[10px] bg-[#FAFAF9] hover:bg-[#F5F2F0] text-[#151617] border-2 border-[#151617] shadow-comic-sm transition-all"
            ...
            <button
              ...
              className="h-[40px] px-5 rounded-[10px] bg-[#FFBE98] hover:bg-[#ffa978] text-[#151617] font-bold text-xs uppercase tracking-wide border-2 border-[#151617] shadow-comic btn-press flex items-center gap-2 cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-6">
          <div className="p-5 rounded-[14px] bg-[#FAFAF9] border-2 border-[#151617] shadow-comic flex flex-col justify-between">
            ...
            <div className="mt-3 font-display text-3xl text-[#151617]">{sites.length}</div>
          ...
          <div className="p-5 rounded-[14px] bg-[#FAFAF9] border-2 border-[#151617] shadow-comic flex flex-col justify-between">
            ...
            <div className="mt-3 font-display text-3xl text-[#151617]">{totalTools}</div>
          ...
          <div className="p-5 rounded-[14px] bg-[#FAFAF9] border-2 border-[#151617] shadow-comic flex flex-col justify-between">
            ...
            <div className="mt-3 font-display text-3xl text-[#151617]">{telemetry.length}</div>
            <div className="mt-1 text-[11px] font-bold text-[#151617]/70 font-mono">
          ...
          <div className="p-5 rounded-[14px] bg-[#FAFAF9] border-2 border-[#151617] shadow-comic flex flex-col justify-between">
            ...
            <div className="mt-3 font-display text-3xl text-[#151617]">100%</div>
            <div className="mt-1 text-[11px] font-bold text-[#151617]/70 font-mono">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-[10px] bg-[#FAFAF9] border-2 border-[#151617] text-xs font-semibold text-[#151617] placeholder:text-[#151617]/40 focus:outline-none shadow-comic-sm"
            />
          </div>
          <div className="text-xs font-mono font-bold text-[#151617]/60 flex items-center gap-2">
        ...
        {isLoadingSites ? (
          <div className="p-12 text-center mt-6 bg-[#FAFAF9] border-2 border-[#151617] rounded-[14px] shadow-comic">
            <Cpu className="h-8 w-8 text-[#151617] animate-spin mx-auto mb-2" />
            <p className="font-mono text-xs font-bold text-[#151617]">Loading database records...</p>
          </div>
        ) : filteredSites.length === 0 ? (
          <div className="p-10 text-center mt-6 bg-[#FAFAF9] border-2 border-[#151617] rounded-[16px] shadow-comic-lg">
            <div className="w-12 h-12 rounded-[12px] bg-[#FFBE98] border-2 border-[#151617] shadow-comic-sm flex items-center justify-center mx-auto mb-4">
              <Globe className="h-6 w-6 text-[#151617]" />
            </div>
            <h3 className="font-display text-xl text-[#151617]">NO WEBSITES REGISTERED YET</h3>
            <p className="text-sm font-medium text-[#151617]/70 max-w-md mx-auto mt-2 leading-relaxed">
              Enter any documentation, SaaS landing page, agency, or digital product URL to crawl and synthesize Web MCP tools.
            </p>
            <button
              onClick={() => setShowAddModal(true)}
              className="mt-6 px-6 py-2.5 rounded-[10px] bg-[#B09CFB] hover:bg-[#9078F0] text-[#151617] font-bold text-xs uppercase border-2 border-[#151617] shadow-comic btn-press inline-flex items-center gap-2 cursor-pointer"
            >
              <Plus className="h-4 w-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
            {filteredSites.map((site) => (
              <div
                key={site.site_id}
                className="p-5 sm:p-6 rounded-[14px] bg-[#FAFAF9] border-2 border-[#151617] shadow-comic flex flex-col justify-between hover:shadow-comic-lg transition-all"
              >
                <div>
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      className="p-1 rounded-[6px] text-[#151617]/40 hover:text-[#FF5F56] hover:bg-[#F5F2F0] transition-colors"
                      title="Remove site"
                    >
                  ...
                  {/* Tool Badges */}
                  <div className="mt-4">
                    <div className="text-[10px] font-mono font-bold text-[#151617]/60 uppercase mb-1.5">
                ...
                <div className="mt-5 pt-3 border-t-2 border-[#151617]/10 flex items-center justify-between">
                  <span className="font-mono text-[10px] text-[#151617]/60">
                    ID: {site.site_id}
                  </span>
                  <Link
                    href={`/studio/${site.site_id}`}
                    className="h-[32px] px-3.5 rounded-[8px] bg-[#FFBE98] hover:bg-[#ffa978] text-[#151617] font-bold text-xs uppercase border-2 border-[#151617] shadow-comic-sm btn-press flex items-center gap-1.5"
                  >
        ...
        <div className="mt-8 p-6 rounded-[14px] bg-[#0D0E0F] text-[#FAFAF9] border-2 border-[#151617] shadow-comic-lg">
          <div className="flex items-center justify-between pb-3 border-b border-white/10">
            ...
            <span className="px-2 py-0.5 rounded-[9999px] bg-[#4ECB71] text-[#151617] font-mono text-[9px] font-bold">
            ...
            <div className="mt-3 space-y-2 font-mono text-xs text-white/80 max-h-64 overflow-y-auto">
              {telemetry.map((evt) => (
                <div key={evt.id} className="p-2.5 rounded-[8px] bg-[#151617] border border-white/10 flex items-center justify-between">
                  ...
                  <span className="text-white/40 text-[10px]">{evt.duration_ms}ms</span>
                </div>
              ))}
            </div>
          )}
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-[#FAFAF9] border-2 border-[#151617] shadow-comic-xl rounded-[16px] max-w-lg w-full p-6 sm:p-8 relative">
            <div className="flex items-center justify-between pb-3 border-b-2 border-[#151617]">
              ...
              <button
                ...
                className="font-mono text-xs font-bold text-[#151617] p-1 rounded-[6px] bg-[#FFBE98] border-2 border-[#151617]"
              >
                [✕]
              </button>
            </div>
            ...
            <form onSubmit={handleCreateSite} className="mt-5 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-[10px] bg-[#F5F2F0] border-2 border-[#151617] text-xs font-semibold text-[#151617] focus:outline-none"
                  disabled={isScanning}
                  autoFocus
                />
              </div>
              ...
              {isScanning && (
                <div className="p-2.5 rounded-[8px] bg-[#B09CFB] border-2 border-[#151617] text-xs font-bold text-[#151617] flex items-center gap-2 animate-pulse">
              ...
              <div className="mt-5 flex justify-end gap-2.5">
                <button
                  type="button"
                  onClick={() => setShowAddModal(false)}
                  className="px-4 py-2 rounded-[10px] bg-[#F5F2F0] text-[#151617] font-bold text-xs uppercase border-2 border-[#151617]"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-5 py-2 rounded-[10px] bg-[#FFBE98] hover:bg-[#ffa978] text-[#151617] font-bold text-xs uppercase border-2 border-[#151617] shadow-comic-sm btn-press flex items-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {isScanning ? <Cpu className="h-4 w-4 animate-spin" /> : <ArrowRight className="h-4 w-4" />}
